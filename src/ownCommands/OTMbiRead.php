...
class OTMbiRead extends Command{
    protected $outmsg=array();
    protected function configure()
    {
        $this
            ->setName('otm-bi-read')
            ->setDescription('Command for show results creation test entities to demonstrate One-To-Many (Many-To-One) bidirectional association')
            ->setDefinition(array())
            ->setHelp(<<<EOT
